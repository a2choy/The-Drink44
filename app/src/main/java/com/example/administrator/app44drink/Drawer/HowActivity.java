...
public class HowActivity extends AppCompatActivity implements AdapterView.OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        home.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(HowActivity.this, com.example.administrator.app44drink.MainActivity.class);
        ...
        myTv.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(HowActivity.this, MyActivity.class);
                startActivity(intent);
                finish();
            }
        });
        ...
        noticeTv.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(HowActivity.this, NoticeActivity.class);
                startActivity(intent);
                finish();
            }
        });
        ...
        askTv.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(HowActivity.this, AskActivity.class);
                startActivity(intent);
                finish();
            }
        });
        ...
        settingTv.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(HowActivity.this, SettingActivity.class);
                startActivity(intent);
                finish();
            }
        });
    ...
    public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
        Intent intent = new Intent(this, com.example.administrator.app44drink.Drawer.How2Activity.class);
